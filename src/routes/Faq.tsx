...
const Faq = () => {
    ...
    const loaders = [
        useTimeout(() => !questions && setStatusText('Loading...'), 100),
        // useTimeout(() => !questions && setStatusText('Still loading...'), 100),
        // useTimeout(() => !questions && setStatusText('Backend still didn\'t return results...'), 100)
    ];
